...
# -*- coding: utf-8 -*-
"""
Générateur de Site/js/data/exercises.js
Construit la banque d'exercices adaptatifs pour les 18 chapitres de 3ème,
organisés en 4 paliers de difficulté ZPD.
"""
...
OUTPUT_FILE = os.path.join(BASE_DIR, "Site/js/data/exercises.js")

# On définit une structure riche et équilibrée d'exercices progressifs pour chaque chapitre
# avec validation exacte, QCM explicatifs, indices d'étayage et solutions détaillées.

EXERCISES_DATABASE = {
    "N1": [
        # --- Palier 1 : Socle & Automatismes ---
        {
            "id": "N1-1",
            "chapterId": "N1",
            "tier": 1,
    ...
    "N2": [
        ...
        },
        {
            ...
            "type": "mcq",
            "options": ["$x^2 + 12x + 36$", "$x^2 + 36$", "$x^2 + 6x + 36$", "$2x + 12$"],
            "correctIndex": 0,
            "explanations": [
        ...
        },
        {
            ...
            "type": "mcq",
            "options": ["$9x^2 - 16$", "$9x^2 + 16$", "$3x^2 - 16$", "$9x^2 - 24x - 16$"],
            "correctIndex": 0,
            "explanations": [
        ...
        # --- Palier 2 : Entraînement Guidé ---
        {
            ...
            "type": "mcq",
            "options": ["$6x^2 - 5x - 4$", "$6x^2 + 5x - 4$", "$6x^2 - 4$", "$5x^2 - 5x - 4$"],
            "correctIndex": 0,
            "explanations": [
        ...
        },
        {
            ...
            "type": "mcq",
            "options": ["$5x(3x - 2)$", "$5(3x^2 - 2x)$", "$x(15x - 10)$", "$15x(x - 2)$"],
            "correctIndex": 0,
            "explanations": [
        ...
        # --- Palier 4 : Défi Seconde ---
        {
            ...
            "type": "mcq",
            "options": ["$(2x + 2)(2x - 8)$ ou $4(x+1)(x-4)$", "$(2x - 28)(2x + 22)$", "$(2x - 8)^2$", "$4x^2 - 12x - 16$"],
            "correctIndex": 0,
            "explanations": [
    ...
    "G0": [
        ...
        # --- Palier 2 : Entraînement Guidé ---
        {
            ...
            "type": "mcq",
            "options": ["Oui, car $13^2 = 5^2 + 12^2 = 169$", "Non, car $5+12 \\neq 13$", "On ne peut pas savoir sans connaître les angles", "Non, car $13^2 = 169$ et $5^2+12^2=144$"],
            "correctIndex": 0,
            "explanations": [
    ...
    "G1": [
        ...
        },
        {
            ...
            "answer": "6",
            "placeholder": "Ex: 6",
            "hint1": "D'après le théorème de Thalès, $\\frac{AM}{AB} = \\frac{AN}{AC}$.",
            "hint2": "$\\frac{4}{10} = \\frac{AN}{15} \\implies AN = \\frac{4 \\times 15}{10}$.",
            "solution": "Comme $(MN) \\parallel (BC)$, d'après le théorème de Thalès :\n$$\\frac{AM}{AB} = \\frac{AN}{AC} \\implies \\frac{4}{10} = \\frac{AN}{15} \\implies AN = \\frac{4 \\times 15}{10} = \\frac{60}{10} = 6\\text{ cm}$$",
            "skill": "Calculer"
        },
        # --- Palier 2 : Entraînement Guidé ---
        {
            ...
            "answer": "6",
            "placeholder": "Ex: 6",
            "hint1": "En configuration papillon, les rapports égaux sont $\\frac{OA}{OB} = \\frac{OD}{OC} = \\frac{AD}{BC}$.",
            "hint2": "$\\frac{6}{9} = \\frac{4}{OC} \\implies 6 \\times OC = 9 \\times 4 = 36$.",
            "solution": "D'après le théorème de Thalès en configuration papillon :\n$$\\frac{OA}{OB} = \\frac{OD}{OC} \\implies \\frac{6}{9} = \\frac{4}{OC} \\implies OC = \\frac{9 \\times 4}{6} = \\frac{36}{6} = 6\\text{ cm}$$",
            "skill": "Calculer"
        },
        # --- Palier 3 : Type Brevet ---
        {
    ...
    "Algo": [
        ...
        },
        {
            ...
            "type": "mcq",
            "options": ["=2*A3 + 5", "=2*A1 + 5", "=2*C1 + 5", "=2*B3 + 5"],
            "correctIndex": 0,
            "explanations": [
...
# Complétons les exercices pour l'ensemble des autres chapitres (N3, G3, G4, G5, G6, G7, Org1, Org2, Org3, Org4)
ADDITIONAL_CHAPTERS = {
    "N3": [
        {
            "id": "N3-1", "chapterId": "N3", "tier": 1, "title": "Produit de puissances",
            "statement": "Écrire sous la forme d'une seule puissance de 10 :\n$$A = 10^4 \\times 10^3$$",
            "type": "mcq", "options": ["$10^7$", "$10^{12}$", "$10^1$", "$100^7$"], "correctIndex": 0,
            "explanations": ["Parfait ! Règle $10^n \\times 10^m = 10^{n+m}$. On additionne les exposants : $4 + 3 = 7$.", "Tu as multiplié les exposants au lieu de les additionner !", "Tu as soustrait les exposants.", "On ne multiplie pas la base 10."],
            "hint1": "Règle opératoire : $a^n \\times a^m = a^{n+m}$.", "hint2": "Additionne les deux exposants.",
            "solution": "$$A = 10^{4+3} = 10^7$$", "skill": "Calculer"
        },
        {
            "id": "N3-2", "chapterId": "N3", "tier": 1, "title": "Puissance négative",
            "statement": "Quelle est l'écriture décimale du nombre $10^{-3}$ ?",
            "type": "exact", "answer": "0.001", "placeholder": "Ex: 0.001",
            "hint1": "$10^{-n} = \\frac{1}{10^n}$. Ici, il y a 3 zéros au total avant le chiffre 1.", "hint2": "$10^{-3} = \\frac{1}{1000} = 0,001$.",
            "solution": "$$10^{-3} = \\frac{1}{10^3} = \\frac{1}{1000} = 0,001$$", "skill": "Calculer"
        },
        {
            "id": "N3-3", "chapterId": "N3", "tier": 2, "title": "Écriture scientifique normalisée",
            "statement": "Quelle est l'écriture scientifique du nombre $45\\,000$ ?",
            "type": "mcq", "options": ["$4,5 \\times 10^4$", "$45 \\times 10^3$", "$0,45 \\times 10^5$", "$4,5 \\times 10^{-4}$"], "correctIndex": 0,
            "explanations": ["Exact ! La notation scientifique impose un seul chiffre non nul avant la virgule ($1 \\le a < 10$).", "45 n'est pas strictement inférieur à 10.", "0,45 n'est pas supérieur ou égal à 1.", "L'exposant est positif car 45 000 est un grand nombre."],
            "hint1": "La notation scientifique est de la forme $a \\times 10^n$ avec $1 \\le a < 10$.", "hint2": "Place la virgule après le 4 et compte le décalage.",
            "solution": "$$45\\,000 = 4,5 \\times 10^4$$", "skill": "Raisonner"
        },
        {
            "id": "N3-4", "chapterId": "N3", "tier": 3, "title": "Quotient de puissances (Brevet)",
            "statement": "Calculer et donner l'écriture scientifique de :\n$$B = \\frac{12 \\times 10^5}{3 \\times 10^8}$$",
            "type": "mcq", "options": ["$4 \\times 10^{-3}$", "$4 \\times 10^3$", "$9 \\times 10^{-3}$", "$4 \\times 10^{13}$"], "correctIndex": 0,
            "explanations": ["Excellent ! $\\frac{12}{3} = 4$ et $10^{5 - 8} = 10^{-3}$.", "Attention au signe de l'exposant : $5 - 8 = -3$ !", "Attention, on divise $12$ par $3$, on ne soustrait pas.", "On soustrait les exposants lors d'une division, on ne les additionne pas."],
            "hint1": "Sépare la fraction en deux : $\\frac{12}{3} \\times \\frac{10^5}{10^8}$.", "hint2": "Règle : $\\frac{10^n}{10^m} = 10^{n-m}$.",
            "solution": "$$B = \\frac{12}{3} \\times \\frac{10^5}{10^8} = 4 \\times 10^{5-8} = 4 \\times 10^{-3}$$", "skill": "Calculer"
        },
        {
            "id": "N3-5", "chapterId": "N3", "tier": 4, "title": "Défi Seconde : Vitesse de la lumière",
            ...
            "type": "exact", "answer": "500", "placeholder": "Ex: 500",
            "hint1": "Formule : $t = \\frac{d}{v}$.", "hint2": "$t = \\frac{1,5 \\times 10^{11}}{3 \\times 10^8} = \\frac{1,5}{3} \\times 10^{11 - 8} = 0,5 \\times 10^3$.",
            "solution": "$$t = \\frac{d}{v} = \\frac{1,5 \\times 10^{11}}{3 \\times 10^8} = 0,5 \\times 10^3 = 500\\text{ secondes}$$\n(soit environ 8 minutes et 20 secondes).", "skill": "Modéliser"
        }
    ],

    "G3": [
        {
            "id": "G3-1", "chapterId": "G3", "tier": 1, "title": "Effet de l'homothétie sur les longueurs",
        ...
        },
        {
            ...
            "type": "exact", "answer": "50", "placeholder": "Ex: 50",
            "hint1": "Dans une homothétie de rapport $k$, les aires sont multipliées par $k^2$.",
            "hint2": "$k^2 = 2,5^2 = 6,25$. Calcule $8 \\times 6,25$.",
            "solution": "$$\\text{Aire}' = k^2 \\times \\text{Aire} = 2,5^2 \\times 8 = 6,25 \\times 8 = 50\\text{ cm}^2$$", "skill": "Calculer"
        },
        {
            "id": "G3-3", "chapterId": "G3", "tier": 3, "title": "Effet sur les volumes (Brevet)",
            ...
            "type": "exact", "answer": "120", "placeholder": "Ex: 120",
        ...
        },
        {
            ...
            "solution": "Un rapport négatif $k = -2$ provoque un demi-tour par rapport au centre $O$. Le point $O$ est donc situé entre $A$ et $A'$, et la distance $OA' = |-2| \\times OA = 2 OA$.", "skill": "Raisonner"
        }
    ],

    "G4": [
        {
            "id": "G4-1", "chapterId": "G4", "tier": 1, "title": "Aire de la sphère",
            "statement": "Quelle est la formule exacte de l'aire d'une sphère de rayon $R$ ?",
            "type": "mcq", "options": ["$4 \\pi R^2$", "$\\frac{4}{3} \\pi R^3$", "$\\pi R^2$", "$2 \\pi R$"], "correctIndex": 0,
            "explanations": ["Exact ! $\\mathcal{A} = 4\\pi R^2$.", "C'est la formule du volume de la boule.", "C'est l'aire d'un disque en dimension 2.", "C'est le périmètre d'un cercle (circonférence)."],
            "hint1": "Une aire est de dimension 2 (donc $R^2$).", "hint2": "L'aire de la sphère vaut exactement 4 fois l'aire d'un grand disque équatorial.",
            "solution": "$$\\text{Aire} = 4 \\pi R^2$$", "skill": "Calculer"
        },
        {
            "id": "G4-2", "chapterId": "G4", "tier": 2, "title": "Volume d'une boule",
            ...
            "type": "exact", "answer": "36", "placeholder": "Ex: 36",
            "hint1": "Formule : $\\mathcal{V} = \\frac{4}{3} \\pi R^3$.", "hint2": "$R^3 = 3^3 = 27$. Calcule $\\frac{4}{3} \\times 27$.",
            "solution": "$$\\mathcal{V} = \\frac{4}{3} \\pi \\times 3^3 = \\frac{4}{3} \\pi \\times 27 = 4 \\times 9 \\times \\pi = 36\\pi\\text{ cm}^3$$\nLe coefficient devant $\\pi$ est $36$.", "skill": "Calculer"
        },
        {
            "id": "G4-3", "chapterId": "G4", "tier": 3, "title": "Section d'une sphère par un plan (Brevet)",
            ...
            "type": "exact", "answer": "4", "placeholder": "Ex: 4",
            ...
            "solution": "$$r^2 = R^2 - d^2 = 5^2 - 3^2 = 25 - 9 = 16 \\implies r = \\sqrt{16} = 4\\text{ cm}$$", "skill": "Raisonner"
        },
        {
            "id": "G4-4", "chapterId": "G4", "tier": 4, "title": "Défi Seconde : Coordonnées géographiques",
            "statement": "Un point $P$ situé sur l'Équateur a une latitude de combien de degrés ?",
            "type": "exact", "answer": "0", "placeholder": "Ex: 0",
            "hint1": "L'Équateur est le parallèle d'origine pour la mesure des latitudes.", "hint2": "La latitude varie de 0° à l'Équateur jusqu'à 90° aux Pôles.",
            "solution": "L'Équateur est le parallèle de référence, sa latitude est donc exactement de $0^\\circ$.", "skill": "Raisonner"
        }
    ],

    "G5": [
        {
            "id": "G5-1", "chapterId": "G5", "tier": 1, "title": "Volume d'un pavé droit",
            "statement": "Calculer le volume d'un pavé droit de longueur $8\\text{ cm}$, largeur $5\\text{ cm}$ et hauteur $3\\text{ cm}$ (en $\\text{cm}^3$).",
            "type": "exact", "answer": "120", "placeholder": "Ex: 120",
            "hint1": "$V = L \\times l \\times h$.", "hint2": "$8 \\times 5 = 40$, puis $40 \\times 3 = 120$.",
            "solution": "$$V = 8 \\times 5 \\times 3 = 120\\text{ cm}^3$$", "skill": "Calculer"
        },
        {
            "id": "G5-2", "chapterId": "G5", "tier": 2, "title": "Volume d'une pyramide",
            "statement": "Une pyramide a une base carrée de côté $6\\text{ cm}$ et une hauteur de $10\\text{ cm}$. Quel est son volume en $\\text{cm}^3$ ?",
            "type": "exact", "answer": "120", "placeholder": "Ex: 120",
            "hint1": "$V = \\frac{1}{3} \\times \\text{Aire de la base} \\times h$.", "hint2": "Aire du carré = $6^2 = 36$. Volume = $\\frac{1}{3} \\times 36 \\times 10$.",
            "solution": "$$V = \\frac{1}{3} \\times (6 \\times 6) \\times 10 = \\frac{1}{3} \\times 36 \\times 10 = 12 \\times 10 = 120\\text{ cm}^3$$", "skill": "Calculer"
        },
        {
            "id": "G5-3", "chapterId": "G5", "tier": 3, "title": "Section plane d'un cylindre (Brevet)",
            "statement": "La section d'un cylindre de révolution par un plan parallèle à son axe de révolution est un :",
            "type": "mcq", "options": ["Rectangle", "Disque", "Triangle", "Trapèze"], "correctIndex": 0,
            "explanations": ["Exact ! Couper un cylindre parallèlement à son axe donne toujours un rectangle.", "Le disque s'obtient quand le plan est perpendiculaire à l'axe (parallèle aux bases).", "Un cylindre n'a pas de face triangulaire.", "Les deux bords verticaux sont parallèles et de même hauteur."],
            "hint1": "Imagine couper une boîte de conserve verticalement.", "hint2": "Les génératrices du cylindre sont parallèles.",
            "solution": "La section d'un cylindre par un plan parallèle à son axe de révolution est un **rectangle** (ou un segment si le plan est tangent).", "skill": "Raisonner"
        },
        {
            "id": "G5-4", "chapterId": "G5", "tier": 4, "title": "Défi Seconde : Cône tronqué",
            ...
            "type": "exact", "answer": "10", "placeholder": "Ex: 10",
            "hint1": "Le volume est multiplié par $k^3$.", "hint2": "$k^3 = 0,5^3 = 0,125 = \\frac{1}{8}$. Calcule $\\frac{80}{8}$.",
            "solution": "$$V' = k^3 \\times V = (0,5)^3 \\times 80 = \\frac{1}{8} \\times 80 = 10\\text{ cm}^3$$", "skill": "Calculer"
        }
    ],

    "G6": [
        {
            "id": "G6-1", "chapterId": "G6", "tier": 1, "title": "Angle de rotation d'un polygone régulier",
            ...
            "type": "exact", "answer": "60", "placeholder": "Ex: 60",
            "hint1": "Un tour complet vaut $360^\\circ$. Divise par le nombre de sommets.", "hint2": "$360 \\div 6 = 60$.",
            "solution": "$$\\alpha = \\frac{360^\\circ}{6} = 60^\\circ$$", "skill": "Calculer"
        },
        {
            "id": "G6-2", "chapterId": "G6", "tier": 2, "title": "Sens trigonométrique et horaire",
            ...
            "hint1": "Le préfixe « anti- » signifie contre ou inverse.", "hint2": "Anti-horaire = contraire des aiguilles.",
            "solution": "Le sens anti-horaire est le sens inverse des aiguilles d'une montre.", "skill": "Raisonner"
        },
        {
            "id": "G6-3", "chapterId": "G6", "tier": 3, "title": "Conservation par rotation (Brevet)",
            "statement": "Un triangle d'aire $18\\text{ cm}^2$ subit une rotation de $75^\\circ$. Quelle est l'aire du triangle image en $\\text{cm}^2$ ?",
            "type": "exact", "answer": "18", "placeholder": "Ex: 18",
            "hint1": "La rotation est une isométrie : elle conserve les longueurs, les angles et les aires !", "hint2": "L'aire ne change pas lors d'une rotation.",
            "solution": "La rotation conserve les aires. L'aire du triangle image est donc exactement égale à $18\\text{ cm}^2$.", "skill": "Raisonner"
        },
        {
            "id": "G6-4", "chapterId": "G6", "tier": 4, "title": "Défi Seconde : Rotation de 180°",
            ...
            "hint1": "Un angle de 180° correspond à un demi-tour.", "hint2": "Le point $O$ est le milieu du segment $[MM']$.",
            "solution": "Une rotation de $180^\\circ$ de centre $O$ est identique à la **symétrie centrale** de centre $O$.", "skill": "Raisonner"
        }
    ],

    "G7": [
        {
            "id": "G7-1", "chapterId": "G7", "tier": 1, "title": "Angles de triangles semblables",
            "statement": "Deux triangles ont des angles de même mesure deux à deux. Ces triangles sont dits :",
            "type": "mcq", "options": ["Semblables", "Égaux", "Isocèles", "Rectangles"], "correctIndex": 0,
            "explanations": [
            ...
            "hint1": "Ils ont la même forme mais pas forcément la même taille.", "hint2": "C'est la définition officielle du chapitre.",
            "solution": "Deux triangles ayant leurs angles deux à deux de même mesure sont des **triangles semblables**.", "skill": "Raisonner"
        },
        {
            "id": "G7-2", "chapterId": "G7", "tier": 2, "title": "Somme des angles et similitude",
            ...
            "solution": "Dans le triangle 1 : $180^\\circ - (45^\\circ + 65^\\circ) = 70^\\circ$. Les deux triangles ont donc les mêmes angles ($45^\\circ, 65^\\circ, 70^\\circ$), ils sont semblables.", "skill": "Raisonner"
        },
        {
            "id": "G7-3", "chapterId": "G7", "tier": 3, "title": "Proportionnalité des côtés (Brevet)",
        ...
        },
        {
            ...
            "hint1": "Les côtés sont proportionnels d'après Thalès.", "hint2": "Deux triangles à côtés proportionnels ont la même forme : ils sont semblables.",
            "solution": "Le théorème de Thalès garantit que les côtés sont proportionnels et les angles égaux : les triangles formés sont donc **semblables**.", "skill": "Raisonner"
        }
    ],

    "Org1": [
        {
            "id": "Org1-1", "chapterId": "Org1", "tier": 1, "title": "Calcul d'image par une formule",
            "statement": "Soit la fonction $f(x) = 3x - 5$. Calculer l'image de $4$ par la fonction $f$.",
            "type": "exact", "answer": "7", "placeholder": "Ex: 7",
            "hint1": "Remplace $x$ par $4$ dans l'expression $3x - 5$.", "hint2": "$f(4) = 3 \\times 4 - 5 = 12 - 5$.",
            "solution": "$$f(4) = 3 \\times 4 - 5 = 12 - 5 = 7$$", "skill": "Calculer"
        },
        {
            "id": "Org1-2", "chapterId": "Org1", "tier": 1, "title": "Vocabulaire Image et Antécédent",
            ...
            "hint1": "L'image sort de la fonction, l'antécédent entre dans la fonction.", "hint2": "$f(\\text{antécédent}) = \\text{image}$.",
            "solution": "Dans $f(2) = 8$, $2$ est l'antécédent et $8$ est son image par $f$.", "skill": "Raisonner"
        },
        {
            "id": "Org1-3", "chapterId": "Org1", "tier": 2, "title": "Recherche d'antécédent par équation",
            "statement": "Soit la fonction $g(x) = 5x + 4$. Trouver l'antécédent de $19$ par $g$.",
            "type": "exact", "answer": "3", "placeholder": "Ex: 3",
            "hint1": "Résous l'équation $g(x) = 19$, c'est-à-dire $5x + 4 = 19$.", "hint2": "$5x = 19 - 4 = 15 \\implies x = 15/5$.",
            "solution": "$$5x + 4 = 19 \\implies 5x = 15 \\implies x = 3$$\nL'antécédent de 19 est 3.", "skill": "Calculer"
        },
        {
            "id": "Org1-4", "chapterId": "Org1", "tier": 3, "title": "Lecture sur courbe (Brevet)",
            ...
            "hint1": "Les antécédents se lisent sur les abscisses ($x$), donc on part de l'ordonnée ($y$) pour les trouver.", "hint2": "Image = axe vertical ; Antécédent = axe horizontal.",
            "solution": "On se place sur l'axe des ordonnées à la valeur $y = 3$, puis on projette horizontalement sur la courbe pour lire les abscisses $x$ des points d'intersection.", "skill": "Raisonner"
        },
        {
            "id": "Org1-5", "chapterId": "Org1", "tier": 4, "title": "Défi Seconde : Nombre d'antécédents",
            "statement": "Soit la fonction $h(x) = x^2$. Combien d'antécédents le nombre $16$ possède-t-il par $h$ ?",
            "type": "exact", "answer": "2", "placeholder": "Ex: 2",
            "hint1": "Résous $x^2 = 16$. N'oublie pas le nombre négatif !", "hint2": "$4^2 = 16$ et $(-4)^2 = 16$.",
            "solution": "$$x^2 = 16 \\iff x = 4 \\quad \\text{ou} \\quad x = -4$$\nLe nombre 16 possède exactement 2 antécédents : $-4$ et $4$.", "skill": "Raisonner"
        }
    ],

    "Org2": [
        {
            "id": "Org2-1", "chapterId": "Org2", "tier": 1, "title": "Moyenne simple",
            "statement": "Calculer la moyenne simple de la série suivante : $12, 14, 16, 18$.",
            "type": "exact", "answer": "15", "placeholder": "Ex: 15",
            "hint1": "Additionne toutes les valeurs et divise par le nombre total de valeurs (4).", "hint2": "$\\frac{12 + 14 + 16 + 18}{4} = \\frac{60}{4}$.",
            "solution": "$$\\bar{x} = \\frac{12 + 14 + 16 + 18}{4} = \\frac{60}{4} = 15$$", "skill": "Calculer"
        },
        {
            "id": "Org2-2", "chapterId": "Org2", "tier": 1, "title": "Étendue d'une série",
            "statement": "Calculer l'étendue de la série : $4, 12, 7, 19, 15, 3$.",
            "type": "exact", "answer": "16", "placeholder": "Ex: 16",
            "hint1": "Formule : $\\text{Étendue} = \\text{Valeur Max} - \\text{Valeur Min}$.", "hint2": "Max = 19, Min = 3.",
            "solution": "$$\\text{Étendue} = 19 - 3 = 16$$", "skill": "Calculer"
        },
        {
            "id": "Org2-3", "chapterId": "Org2", "tier": 2, "title": "Médiane d'une série impaire",
            "statement": "Déterminer la médiane de la série de 7 notes : $8, 14, 6, 11, 15, 9, 13$.",
            "type": "exact", "answer": "11", "placeholder": "Ex: 11",
            "hint1": "Attention : commence obligatoirement par ranger les 7 valeurs dans l'ordre croissant !", "hint2": "Ordre : 6, 8, 9, 11, 13, 14, 15. La 4ème valeur est la médiane.",
            "solution": "1. Série ordonnée : $6, 8, 9, \\mathbf{11}, 13, 14, 15$.\n2. L'effectif total $N = 7$ est impair. La médiane est la $\\frac{7+1}{2} = 4^e$ valeur :\n$$Me = 11$$", "skill": "Raisonner"
        },
        {
            "id": "Org2-4", "chapterId": "Org2", "tier": 3, "title": "Moyenne pondérée (Brevet)",
            "statement": "Dans une classe, 10 élèves ont eu 8/20, 15 ont eu 12/20 et 5 ont eu 16/20. Quelle est la moyenne de la classe ?",
            "type": "exact", "answer": "11.33", "placeholder": "Ex: 11.33 ou 34/3",
            ...
            "solution": "$$\\bar{x} = \\frac{10 \\times 8 + 15 \\times 12 + 5 \\times 16}{10 + 15 + 5} = \\frac{80 + 180 + 80}{30} = \\frac{340}{30} = \\frac{34}{3} \\approx 11,33$$", "skill": "Calculer"
        },
        {
            "id": "Org2-5", "chapterId": "Org2", "tier": 4, "title": "Défi Seconde : Médiane paire",
            "statement": "Déterminer la médiane de la série de 6 valeurs : $4, 7, 9, 12, 15, 18$.",
            "type": "exact", "answer": "10.5", "placeholder": "Ex: 10.5",
            ...
            "solution": "Comme l'effectif total est pair ($N=6$), la médiane est la demi-somme des 3e et 4e valeurs ordonnées :\n$$Me = \\frac{9 + 12}{2} = \\frac{21}{2} = 10,5$$", "skill": "Calculer"
        }
    ],

    "Org3": [
        {
            "id": "Org3-1", "chapterId": "Org3", "tier": 1, "title": "Fonction linéaire et proportionnalité",
            "statement": "Parmi les fonctions suivantes, laquelle est une fonction linéaire ?",
            "type": "mcq", "options": ["$f(x) = 4x$", "$g(x) = 4x + 3$", "$h(x) = x^2$", "$k(x) = \\frac{4}{x}$"], "correctIndex": 0,
            "explanations": ["Exact ! Une fonction linéaire est de la forme $f(x) = ax$. Sa droite passe par l'origine.", "C'est une fonction affine non linéaire ($b \\neq 0$).", "C'est la fonction carré.", "C'est la fonction inverse."],
            "hint1": "Une fonction linéaire traduit une situation de proportionnalité ($ax$).", "hint2": "Elle n'a pas de terme constant ajouté.",
            "solution": "La fonction $f(x) = 4x$ est de la forme $ax$ : c'est une **fonction linéaire**.", "skill": "Raisonner"
        },
        {
            "id": "Org3-2", "chapterId": "Org3", "tier": 1, "title": "Ordonnée à l'origine",
            "statement": "Quelle est l'ordonnée à l'origine de la droite représentant la fonction affine $f(x) = -3x + 7$ ?",
            "type": "exact", "answer": "7", "placeholder": "Ex: 7",
            "hint1": "Pour une fonction affine $f(x) = ax + b$, l'ordonnée à l'origine est le nombre $b$.", "hint2": "Ici $a = -3$ et $b = 7$.",
            "solution": "Pour $f(x) = ax + b$, l'ordonnée à l'origine est $b = 7$ (point de coordonnées $(0 ; 7)$).", "skill": "Calculer"
        },
        {
            "id": "Org3-3", "chapterId": "Org3", "tier": 2, "title": "Sens de variation d'une fonction affine",
            ...
            "hint1": "Regarde le signe du coefficient directeur devant $x$ ($a$).", "hint2": "Si $a < 0$, la fonction est décroissante.",
            "solution": "Comme le coefficient directeur $a = -5 < 0$, la fonction $f$ est **strictement décroissante**.", "skill": "Raisonner"
        },
        {
            "id": "Org3-4", "chapterId": "Org3", "tier": 3, "title": "Calcul du coefficient directeur (Brevet)",
            "statement": "Une droite affine passe par les points $A(2 ; 3)$ et $B(6 ; 11)$. Quel est son coefficient directeur ?",
            "type": "exact", "answer": "2", "placeholder": "Ex: 2",
            "hint1": "Formule : $a = \\frac{y_B - y_A}{x_B - x_A}$.", "hint2": "$a = \\frac{11 - 3}{6 - 2} = \\frac{8}{4}$.",
            "solution": "$$a = \\frac{y_B - y_A}{x_B - x_A} = \\frac{11 - 3}{6 - 2} = \\frac{8}{4} = 2$$", "skill": "Calculer"
        },
        {
            "id": "Org3-5", "chapterId": "Org3", "tier": 4, "title": "Défi Seconde : Déterminer la fonction complète",
            ...
            "type": "exact", "answer": "4", "placeholder": "Ex: 4",
            "hint1": "Écris $f(2) = 3 \\times 2 + b = 10$.", "hint2": "$6 + b = 10 \\implies b = 10 - 6$.",
            "solution": "$$f(2) = 3(2) + b = 10 \\implies 6 + b = 10 \\implies b = 4$$\nLa fonction est donc $f(x) = 3x + 4$.", "skill": "Calculer"
        }
    ],

    "Org4": [
        {
            "id": "Org4-1", "chapterId": "Org4", "tier": 1, "title": "Lancer de dé équilibré",
            "statement": "On lance un dé équilibré à 6 faces. Quelle est la probabilité d'obtenir un nombre pair ?",
            "type": "exact", "answer": "0.5", "placeholder": "Ex: 0.5 ou 1/2",
            "hint1": "Il y a 3 nombres pairs : 2, 4 et 6. Le nombre total de faces est 6.", "hint2": "$P = \\frac{3}{6} = \\frac{1}{2} = 0,5$.",
            "solution": "Les issues favorables sont $\\{2, 4, 6\\}$ (soit 3 issues sur 6) :\n$$P = \\frac{3}{6} = \\frac{1}{2} = 0,5$$", "skill": "Calculer"
        },
        {
            "id": "Org4-2", "chapterId": "Org4", "tier": 1, "title": "Événement contraire",
            "statement": "La probabilité qu'il pleuve demain est de $0,35$. Quelle est la probabilité qu'il ne pleuve pas ?",
            "type": "exact", "answer": "0.65", "placeholder": "Ex: 0.65",
            "hint1": "Formule : $P(\\overline{A}) = 1 - P(A)$.", "hint2": "$1 - 0,35 = 0,65$.",
            "solution": "$$P(\\overline{A}) = 1 - P(A) = 1 - 0,35 = 0,65$$", "skill": "Calculer"
        },
        {
            "id": "Org4-3", "chapterId": "Org4", "tier": 2, "title": "Tirage dans une urne",
            ...
            "type": "exact", "answer": "1/3", "placeholder": "Ex: 1/3",
            "hint1": "Calcule le nombre total de boules dans l'urne : $4 + 3 + 5 = 12$.", "hint2": "Probabilité = $\\frac{4}{12}$. Simplifie la fraction.",
            "solution": "Nombre total de boules : $4 + 3 + 5 = 12$.\n$$P(\\text{Rouge}) = \\frac{4}{12} = \\frac{1}{3}$$", "skill": "Calculer"
        },
        {
            "id": "Org4-4", "chapterId": "Org4", "tier": 3, "title": "Arbre à deux épreuves (Brevet)",
            ...
            "type": "exact", "answer": "1/4", "placeholder": "Ex: 1/4",
            ...
            "solution": "D'après la règle du produit dans un arbre de probabilités :\n$$P(\\text{Pile, Pile}) = \\frac{1}{2} \\times \\frac{1}{2} = \\frac{1}{4} = 0,25$$", "skill": "Modéliser"
        },
        {
            "id": "Org4-5", "chapterId": "Org4", "tier": 4, "title": "Défi Seconde : Au moins un Pile en 3 lancers",
            "statement": "On lance 3 fois une pièce équilibrée. Quelle est la probabilité d'obtenir au moins une fois Pile ?",
            "type": "exact", "answer": "7/8", "placeholder": "Ex: 7/8",
            ...
            "solution": "1. Événement contraire : « obtenir 3 fois Face » :\n$$P(\\text{Face, Face, Face}) = \\frac{1}{2} \\times \\frac{1}{2} \\times \\frac{1}{2} = \\frac{1}{8}$$\n2. Probabilité cherchée :\n$$P(\\text{au moins un Pile}) = 1 - \\frac{1}{8} = \\frac{7}{8}$$", "skill": "Raisonner"
        }
    ]
}

EXERCISES_DATABASE.update(ADDITIONAL_CHAPTERS)

with open(OUTPUT_FILE, "w", encoding="utf-8") as fp:
    fp.write("// Base de données des exercices interactifs par chapitre et par palier ZPD (1 à 4)\n")
    fp.write("window.MATHS_EXERCISES = ")
    json.dump(EXERCISES_DATABASE, fp, ensure_ascii=False, indent=2)
    fp.write(";\n")

total_exos = sum(len(v) for v in EXERCISES_DATABASE.values())
print(f"Génération de exercises.js terminée : {len(EXERCISES_DATABASE)} chapitres, {total_exos} exercices interactifs progressifs.")
